...
export declare class BaseMergedExtractor implements IDateTimeExtractor {
    ...
    private static readonly NumberOrConnectorRegex;
    constructor(config: IMergedExtractorConfiguration, options: DateTimeOptions);
    extract(source: string, refDate: Date): ExtractResult[];
    private checkCalendarFilterList;
    private numberEndingRegexMatch;
    protected addTo(destination: ExtractResult[], source: ExtractResult[], text: string): void;
    private shouldSkipFromMerge;
    private filterUnspecificDatePeriod;
    private filterAmbiguity;
    private filterAmbiguousSingleWord;
    protected addMod(ers: ExtractResult[], source: string): void;
    protected tryMergeModifierToken(er: ExtractResult, regex: RegExp, source: string, potentialAmbiguity?: boolean): boolean;
    protected assignModMetadata(metadata: MetaData): MetaData;
    protected hasTokenIndex(source: string, regex: RegExp): {
        matched: boolean;
        index: number;
    };
}
...
export declare class BaseMergedParser implements IDateTimeParser {
    ...
    private readonly dateDefaultValue;
    ...
    dateTimeResolutionForSplit(slot: DateTimeParseResult): DateTimeParseResult[];
    ...
    private addSingleDateTimeToResolution;
    private addPeriodToResolution;
    protected getValues(obj: any): any[];
    protected processDoubleTimex(resolutionDic: Map<string, any>, futureKey: string, pastKey: string, originTimex: string): void;
    private HasDoubleTimex;
