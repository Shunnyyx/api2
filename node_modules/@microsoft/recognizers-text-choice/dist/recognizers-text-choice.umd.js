        ...
        match.forEach(matchToken => {
            ...
            if (pos >= 0) {
                ...
                if (distance <= this.config.maxDistance) {
                    ...
                    startPos = pos + 1;
                    emojiSkinToneMatch += recognizersText.RegExpUtility.getMatches(this.config.emojiSkinToneRegex, matchToken).length;
                }
            }
        });
        let score = 0.0;
        let emojiSkinToneLen = recognizersText.RegExpUtility.getMatches(this.config.emojiSkinToneRegex, source.join()).length;
...
(function (ChineseChoice) {
    ...
    ChineseChoice.SkinToneRegex = `(\\uD83C\\uDFFB|\\uD83C\\uDFFC|\\uD83C\\uDFFD|\\uD83C\\uDFFE|\\uD83C\\uDFFF)`;
    ChineseChoice.TrueRegex = `(好[的啊呀嘞哇]|没问题|可以|中|好|同意|行|是的|是|对)|(\\uD83D\\uDC4D|\\uD83D\\uDC4C)${ChineseChoice.SkinToneRegex}?`;
    ChineseChoice.FalseRegex = `(不行|不好|拒绝|否定|不中|不可以|不是的|不是|不对|不)|(\\uD83D\\uDC4E|\\u270B|\\uD83D\\uDD90)${ChineseChoice.SkinToneRegex}?`;
...
class ChineseBooleanExtractorConfiguration {
    constructor(onlyTopMatch = true) {
        this.emojiSkinToneRegex = recognizersText.RegExpUtility.getSafeRegExp(chineseChoice.ChineseChoice.SkinToneRegex);
...
var dutchChoice = createCommonjsModule(function (module, exports) {
"use strict";
// ------------------------------------------------------------------------------
// <auto-generated>
//     This code was generated by a tool.
...
Object.defineProperty(exports, "__esModule", { value: true });
var DutchChoice;
(function (DutchChoice) {
    DutchChoice.LangMarker = `Nl`;
    DutchChoice.TokenizerRegex = `[^\\w\\d]`;
    DutchChoice.SkinToneRegex = `(\\uD83C\\uDFFB|\\uD83C\\uDFFC|\\uD83C\\uDFFD|\\uD83C\\uDFFE|\\uD83C\\uDFFF)`;
    DutchChoice.TrueRegex = `\\b(ja|jawel|jazeker|natuurlijk|vanzelfsprekend|zeker|prima|jep|yes|yep|y|ok|oke|akkoord)\\b|(\\uD83D\\uDC4D|\\uD83D\\uDC4C)${DutchChoice.SkinToneRegex}?`;
    DutchChoice.FalseRegex = `\\b(nee|neen|nope|nein|nop|no|niet|nooit)\\b|(\\uD83D\\uDC4E|\\u270B|\\uD83D\\uDD90)${DutchChoice.SkinToneRegex}?`;
})(DutchChoice = exports.DutchChoice || (exports.DutchChoice = {}));

});

unwrapExports(dutchChoice);
...
class DutchBooleanExtractorConfiguration {
    constructor(onlyTopMatch = true) {
        this.emojiSkinToneRegex = recognizersText.RegExpUtility.getSafeRegExp(dutchChoice.DutchChoice.SkinToneRegex);
        this.regexTrue = recognizersText.RegExpUtility.getSafeRegExp(dutchChoice.DutchChoice.TrueRegex);
        this.regexFalse = recognizersText.RegExpUtility.getSafeRegExp(dutchChoice.DutchChoice.FalseRegex);
        this.tokenRegex = recognizersText.RegExpUtility.getSafeRegExp(dutchChoice.DutchChoice.TokenizerRegex, 'is');
        this.onlyTopMatch = onlyTopMatch;
    }
}
exports.DutchBooleanExtractorConfiguration = DutchBooleanExtractorConfiguration;
...
(function (EnglishChoice) {
    ...
    EnglishChoice.SkinToneRegex = `(\\uD83C\\uDFFB|\\uD83C\\uDFFC|\\uD83C\\uDFFD|\\uD83C\\uDFFE|\\uD83C\\uDFFF)`;
    EnglishChoice.TrueRegex = `\\b(true|yes|yep|yup|yeah|y|sure|ok|agree)\\b|(\\uD83D\\uDC4D|\\uD83D\\uDC4C|\\u0001f44c)${EnglishChoice.SkinToneRegex}?`;
    EnglishChoice.FalseRegex = `\\b(false|nope|nop|no|not\\s+ok|disagree)\\b|(\\uD83D\\uDC4E|\\u270B|\\uD83D\\uDD90|\\u0001F44E|\\u0001F590)${EnglishChoice.SkinToneRegex}?`;
...
class EnglishBooleanExtractorConfiguration {
    constructor(onlyTopMatch = true) {
        this.emojiSkinToneRegex = recognizersText.RegExpUtility.getSafeRegExp(englishChoice.EnglishChoice.SkinToneRegex);
...
(function (FrenchChoice) {
    ...
    FrenchChoice.SkinToneRegex = `(\\uD83C\\uDFFB|\\uD83C\\uDFFC|\\uD83C\\uDFFD|\\uD83C\\uDFFE|\\uD83C\\uDFFF)`;
    FrenchChoice.TrueRegex = `\\b(s[uû]r|ouais|oui|yep|y|sure|approuver|accepter|consentir|d'accord|ça march[eé])\\b|(\\uD83D\\uDC4D|\\uD83D\\uDC4C)${FrenchChoice.SkinToneRegex}?`;
    FrenchChoice.FalseRegex = `\\b(faux|nan|non|pas\\s+d'accord|pas\\s+concorder|n'est\\s+pas\\s+(correct|ok)|pas)\\b|(\\uD83D\\uDC4E|\\u270B|\\uD83D\\uDD90)${FrenchChoice.SkinToneRegex}?`;
...
class FrenchBooleanExtractorConfiguration {
    constructor(onlyTopMatch = true) {
        this.emojiSkinToneRegex = recognizersText.RegExpUtility.getSafeRegExp(frenchChoice.FrenchChoice.SkinToneRegex);
        this.regexTrue = recognizersText.RegExpUtility.getSafeRegExp(frenchChoice.FrenchChoice.TrueRegex);
        this.regexFalse = recognizersText.RegExpUtility.getSafeRegExp(frenchChoice.FrenchChoice.FalseRegex);
        this.tokenRegex = recognizersText.RegExpUtility.getSafeRegExp(frenchChoice.FrenchChoice.TokenizerRegex, 'is');
        this.onlyTopMatch = onlyTopMatch;
    }
}
...
(function (GermanChoice) {
    ...
    GermanChoice.SkinToneRegex = `(\\uD83C\\uDFFB|\\uD83C\\uDFFC|\\uD83C\\uDFFD|\\uD83C\\uDFFE|\\uD83C\\uDFFF)`;
    GermanChoice.TrueRegex = `\\b(wahr|ja|jep|j|sicher|ok|einverstanden|mit\\s+Sicherheit|sicherlich|jap|mache ich)\\b|(\\uD83D\\uDC4D|\\uD83D\\uDC4C)${GermanChoice.SkinToneRegex}?`;
    GermanChoice.FalseRegex = `\\b(falsch|nein|ne|nö|nicht\\s+ok|nicht\\s+einverstanden|n)\\b|(\\uD83D\\uDC4E|\\u270B|\\uD83D\\uDD90)${GermanChoice.SkinToneRegex}?`;
...
class GermanBooleanExtractorConfiguration {
    constructor(onlyTopMatch = true) {
        this.emojiSkinToneRegex = recognizersText.RegExpUtility.getSafeRegExp(germanChoice.GermanChoice.SkinToneRegex);
        this.regexTrue = recognizersText.RegExpUtility.getSafeRegExp(germanChoice.GermanChoice.TrueRegex);
        this.regexFalse = recognizersText.RegExpUtility.getSafeRegExp(germanChoice.GermanChoice.FalseRegex);
        this.tokenRegex = recognizersText.RegExpUtility.getSafeRegExp(germanChoice.GermanChoice.TokenizerRegex, 'is');
        this.onlyTopMatch = onlyTopMatch;
    }
}
...
(function (JapaneseChoice) {
    ...
    JapaneseChoice.SkinToneRegex = `(\\uD83C\\uDFFB|\\uD83C\\uDFFC|\\uD83C\\uDFFD|\\uD83C\\uDFFE|\\uD83C\\uDFFF)`;
    JapaneseChoice.TrueRegex = `(はい(！)*|そうです|よい(です)*)|(\\uD83D\\uDC4D|\\uD83D\\uDC4C)${JapaneseChoice.SkinToneRegex}?`;
    JapaneseChoice.FalseRegex = `(いいえ|ではありません|ではない|じゃない|じゃありません)|(\\uD83D\\uDC4E|\\u270B|\\uD83D\\uDD90)${JapaneseChoice.SkinToneRegex}?`;
...
class JapaneseBooleanExtractorConfiguration {
    constructor(onlyTopMatch = true) {
        this.emojiSkinToneRegex = recognizersText.RegExpUtility.getSafeRegExp(japaneseChoice.JapaneseChoice.SkinToneRegex);
...
(function (PortugueseChoice) {
    ...
    PortugueseChoice.SkinToneRegex = `(\\uD83C\\uDFFB|\\uD83C\\uDFFC|\\uD83C\\uDFFD|\\uD83C\\uDFFE|\\uD83C\\uDFFF)`;
    PortugueseChoice.TrueRegex = `\\b(verdade|verdadeir[oa]|sim|isso|claro|ok)\\b|(\\uD83D\\uDC4D|\\uD83D\\uDC4C)${PortugueseChoice.SkinToneRegex}?`;
    PortugueseChoice.FalseRegex = `\\b(falso|n[aã]o|incorreto|nada disso)\\b|(\\uD83D\\uDC4E|\\u270B|\\uD83D\\uDD90)${PortugueseChoice.SkinToneRegex}?`;
...
class PortugueseBooleanExtractorConfiguration {
    constructor(onlyTopMatch = true) {
        this.emojiSkinToneRegex = recognizersText.RegExpUtility.getSafeRegExp(portugueseChoice.PortugueseChoice.SkinToneRegex);
...
(function (SpanishChoice) {
    ...
    SpanishChoice.SkinToneRegex = `(\\uD83C\\uDFFB|\\uD83C\\uDFFC|\\uD83C\\uDFFD|\\uD83C\\uDFFE|\\uD83C\\uDFFF)`;
    SpanishChoice.TrueRegex = `\\b(verdad|verdadero|sí|sip|s|si|cierto|por supuesto|ok)\\b|(\\uD83D\\uDC4D|\\uD83D\\uDC4C)${SpanishChoice.SkinToneRegex}?`;
    SpanishChoice.FalseRegex = `\\b(falso|no|nop|n|no)\\b|(\\uD83D\\uDC4E|\\u270B|\\uD83D\\uDD90)${SpanishChoice.SkinToneRegex}?`;
...
var boolean_1$7 = createCommonjsModule(function (module, exports) {
"use strict";
// Copyright (c) Microsoft Corporation. All rights reserved.
// Licensed under the MIT License.
Object.defineProperty(exports, "__esModule", { value: true });
...
class SpanishBooleanExtractorConfiguration {
    constructor(onlyTopMatch = true) {
        this.emojiSkinToneRegex = recognizersText.RegExpUtility.getSafeRegExp(spanishChoice.SpanishChoice.SkinToneRegex);
...
class ChoiceRecognizer extends recognizersText.Recognizer {
    ...
    InitializeConfiguration() {
        // #region Chinese
        this.registerModel("BooleanModel", recognizersText.Culture.Chinese, (options) => new models$2.BooleanModel(new parsers$2.BooleanParser(), new extractors$2.BooleanExtractor(new boolean_1.ChineseBooleanExtractorConfiguration())));
        // #endregion
        // #region Dutch
        this.registerModel("BooleanModel", recognizersText.Culture.Dutch, (options) => new models$2.BooleanModel(new parsers$2.BooleanParser(), new extractors$2.BooleanExtractor(new boolean_1$1.DutchBooleanExtractorConfiguration())));
        // #endregion
        // #region English
        this.registerModel("BooleanModel", recognizersText.Culture.English, (options) => new models$2.BooleanModel(new parsers$2.BooleanParser(), new extractors$2.BooleanExtractor(new boolean_1$2.EnglishBooleanExtractorConfiguration())));
        // #endregion
        // #region French
        this.registerModel("BooleanModel", recognizersText.Culture.French, (options) => new models$2.BooleanModel(new parsers$2.BooleanParser(), new extractors$2.BooleanExtractor(new boolean_1$3.FrenchBooleanExtractorConfiguration())));
        // #endregion
        // #region German
        this.registerModel("BooleanModel", recognizersText.Culture.German, (options) => new models$2.BooleanModel(new parsers$2.BooleanParser(), new extractors$2.BooleanExtractor(new boolean_1$4.GermanBooleanExtractorConfiguration())));
        // #endregion
        // #region Japanese
        this.registerModel("BooleanModel", recognizersText.Culture.Japanese, (options) => new models$2.BooleanModel(new parsers$2.BooleanParser(), new extractors$2.BooleanExtractor(new boolean_1$5.JapaneseBooleanExtractorConfiguration())));
        // #endregion
        // #region Portuguese
        this.registerModel("BooleanModel", recognizersText.Culture.Portuguese, (options) => new models$2.BooleanModel(new parsers$2.BooleanParser(), new extractors$2.BooleanExtractor(new boolean_1$6.PortugueseBooleanExtractorConfiguration())));
        // #endregion
        // #region Spanish
        this.registerModel("BooleanModel", recognizersText.Culture.Spanish, (options) => new models$2.BooleanModel(new parsers$2.BooleanParser(), new extractors$2.BooleanExtractor(new boolean_1$7.SpanishBooleanExtractorConfiguration())));
        // #endregion
    }
...
exports.ChineseBooleanExtractorConfiguration = boolean_1.ChineseBooleanExtractorConfiguration;

exports.DutchBooleanExtractorConfiguration = boolean_1$1.DutchBooleanExtractorConfiguration;

exports.EnglishBooleanExtractorConfiguration = boolean_1$2.EnglishBooleanExtractorConfiguration;

exports.FrenchBooleanExtractorConfiguration = boolean_1$3.FrenchBooleanExtractorConfiguration;

exports.GermanBooleanExtractorConfiguration = boolean_1$4.GermanBooleanExtractorConfiguration;

exports.JapaneseBooleanExtractorConfiguration = boolean_1$5.JapaneseBooleanExtractorConfiguration;

exports.PortugueseBooleanExtractorConfiguration = boolean_1$6.PortugueseBooleanExtractorConfiguration;

exports.SpanishBooleanExtractorConfiguration = boolean_1$7.SpanishBooleanExtractorConfiguration;

exports.ChineseChoice = chineseChoice.ChineseChoice;

exports.DutchChoice = dutchChoice.DutchChoice;
...
var recognizersTextChoice_12 = recognizersTextChoice.ChineseBooleanExtractorConfiguration;
var recognizersTextChoice_13 = recognizersTextChoice.DutchBooleanExtractorConfiguration;
var recognizersTextChoice_14 = recognizersTextChoice.EnglishBooleanExtractorConfiguration;
var recognizersTextChoice_15 = recognizersTextChoice.FrenchBooleanExtractorConfiguration;
var recognizersTextChoice_16 = recognizersTextChoice.GermanBooleanExtractorConfiguration;
var recognizersTextChoice_17 = recognizersTextChoice.JapaneseBooleanExtractorConfiguration;
var recognizersTextChoice_18 = recognizersTextChoice.PortugueseBooleanExtractorConfiguration;
var recognizersTextChoice_19 = recognizersTextChoice.SpanishBooleanExtractorConfiguration;
var recognizersTextChoice_20 = recognizersTextChoice.ChineseChoice;
var recognizersTextChoice_21 = recognizersTextChoice.DutchChoice;
var recognizersTextChoice_22 = recognizersTextChoice.EnglishChoice;
var recognizersTextChoice_23 = recognizersTextChoice.FrenchChoice;
var recognizersTextChoice_24 = recognizersTextChoice.GermanChoice;
var recognizersTextChoice_25 = recognizersTextChoice.JapaneseChoice;
var recognizersTextChoice_26 = recognizersTextChoice.PortugueseChoice;
var recognizersTextChoice_27 = recognizersTextChoice.SpanishChoice;
...
exports.ChineseBooleanExtractorConfiguration = recognizersTextChoice_12;
exports.DutchBooleanExtractorConfiguration = recognizersTextChoice_13;
exports.EnglishBooleanExtractorConfiguration = recognizersTextChoice_14;
exports.FrenchBooleanExtractorConfiguration = recognizersTextChoice_15;
exports.GermanBooleanExtractorConfiguration = recognizersTextChoice_16;
exports.JapaneseBooleanExtractorConfiguration = recognizersTextChoice_17;
exports.PortugueseBooleanExtractorConfiguration = recognizersTextChoice_18;
exports.SpanishBooleanExtractorConfiguration = recognizersTextChoice_19;
exports.ChineseChoice = recognizersTextChoice_20;
exports.DutchChoice = recognizersTextChoice_21;
exports.EnglishChoice = recognizersTextChoice_22;
exports.FrenchChoice = recognizersTextChoice_23;
exports.GermanChoice = recognizersTextChoice_24;
exports.JapaneseChoice = recognizersTextChoice_25;
exports.PortugueseChoice = recognizersTextChoice_26;
exports.SpanishChoice = recognizersTextChoice_27;
